...
PS_tax <- (0.5* tax_51_q * P_star_51)/100 # $25,081 turning it into dollars
...
```{r}
tax_rev_51 <- (Q_demand_agg_tax(p = 10, scc = 51)) * ((env_cost+10) - Supply_fun(q = Q_tax_51))/100 # = $11,928 of tax revenue (is this too high??? Sandy made it sound like it had to be 4 cents for the height of the tax revenue)
```
