...
total_env_cost_sq <- env_cost * q_star_agg # = $1073439 of env damage under status quo q_star of 536719 kwh
...
demand_agg_tax <- function(p, scc){
  q <- low_demand_tax(p, scc) + demand(p, high.income.lm)
  return(q)
}
tax_51_q <- demand_agg_tax( p = 10, scc = 51) # = 518875 kwh is the q star with scc = to 51
