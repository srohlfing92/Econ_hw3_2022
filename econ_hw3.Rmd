...
#ggplot(data = df, aes(y = price, x = mpc_prices)) +
  #geom_point()+
  #labs(x = "kwH",
   #    y = "Price of kwH",
   #    title = "Supply Curve")
...
```{r}
# 1ton/$51 * 1lb/.0005 tons = $.0255/lb *.85 lb/kwh = $0.01912/kwh
# $ 0.10 + $0.01912 = $0.12/kwh (marginal external cost/kwh)

mec_per_kwh <- 0.12 # <- marginal external cost
```
